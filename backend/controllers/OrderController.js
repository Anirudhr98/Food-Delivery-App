...
export const createorder = async (req, res) => {
    const {
        ...
        user_id, delivery_address, restaurant_id,restaurant_name, created_at, delivered_at
    } = req.body;
...
export const getOrders = async (req, res) => {
    try {
      ...
      res.json({ message: 'Orders found', orders_list });
    } catch (err) {
      console.error(err);
      res.json({ message: 'Error finding orders' });
    }
  };
